...
The total bar height represents the sum of all values. Only the top corners of the topmost segment and the bottom corners of the bottommost segment are rounded, so segments fit together seamlessly.
