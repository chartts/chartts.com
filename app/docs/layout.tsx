...
const sidebar: SidebarSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Remix", href: "/docs/remix" },
      { label: "Astro", href: "/docs/astro" },
      { label: "Nuxt", href: "/docs/nuxt" },
      { label: "SvelteKit", href: "/docs/sveltekit" },
  ...
  },
  {
    title: "Features",
    links: [
      { label: "Streaming / Real-time", href: "/docs/streaming" },
      { label: "Zoom & Pan", href: "/docs/zoom-pan" },
      { label: "Brush Selection", href: "/docs/brush" },
      { label: "Data Zoom", href: "/docs/datazoom" },
      { label: "Export (PNG/SVG)", href: "/docs/export" },
      { label: "Linked Charts", href: "/docs/linked-charts" },
      { label: "Data Decimation", href: "/docs/decimation" },
      { label: "Annotations", href: "/docs/annotations" },
      { label: "Rich Text", href: "/docs/richtext" },
      { label: "Debug Panel", href: "/docs/debug" },
    ],
  },
  {
    title: "Data",
    links: [
      { label: "Data Adapters", href: "/docs/data-adapters" },
      { label: "Financial Indicators", href: "/docs/finance-pkg" },
      { label: "Statistics", href: "/docs/statistics-pkg" },
      { label: "Regression", href: "/docs/regression" },
    ],
  },
  {
    title: "Plugins",
    links: [
      { label: "Custom Chart Types", href: "/docs/plugins" },
      { label: "Annotation Plugin", href: "/docs/annotation-plugin" },
      { label: "Data Labels", href: "/docs/datalabels" },
    ],
  },
  {
    title: "Guides",
    links: [
      { label: "Creating Themes", href: "/docs/theme-creation" },
      { label: "Server Rendering", href: "/docs/ssr" },
      { label: "Testing", href: "/docs/test-utils" },
      { label: "CLI Tool", href: "/docs/cli" },
      { label: "WebSocket Streaming", href: "/docs/websocket" },
      { label: "date-fns Adapter", href: "/docs/date-fns-adapter" },
      { label: "Day.js Adapter", href: "/docs/dayjs-adapter" },
    ],
  },
  {
    title: "Reference",
